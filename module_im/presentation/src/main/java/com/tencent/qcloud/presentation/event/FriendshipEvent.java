...
public class FriendshipEvent extends Observable implements TIMFriendshipProxyListener {
    ...
    public void OnAddFriends(List<TIMUserProfile> list) {
        Log.d(TAG,"===setFriendshipProxyListener===" + "OnAddFriends");
        setChanged();
    ...
    public void OnDelFriends(List<String> list) {
        Log.d(TAG,"===setFriendshipProxyListener===" + "OnDelFriends");
        setChanged();
    ...
    public void OnFriendProfileUpdate(List<TIMUserProfile> list) {
        Log.d(TAG, "===setFriendshipProxyListener===" + "OnFriendProfileUpdate");
        setChanged();
    ...
    public void OnAddFriendReqs(List<TIMSNSChangeInfo> list) {
        Log.d(TAG, "===setFriendshipProxyListener===" + "OnAddFriendReqs");
        setChanged();
...
//    }
    ...
    public void OnFriendGroupUpdate(List<TIMFriendGroup> list) {
        Log.d(TAG, "===setFriendshipProxyListener===" + "OnFriendGroupUpdate");
        setChanged();
        notifyObservers(new NotifyCmd(NotifyType.GROUP_UPDATE, list));
    }
