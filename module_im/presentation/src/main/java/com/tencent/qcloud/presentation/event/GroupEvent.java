...
public class GroupEvent extends Observable implements TIMGroupAssistantListener {
    ...
    public void onMemberJoin(String s, List<TIMGroupMemberInfo> list) {
        Log.d(TAG,"===setGroupAssistantListener===" + "onMemberJoin");
    }


    @Override
    public void onMemberQuit(String s, List<String> list) {
        Log.d(TAG,"===setGroupAssistantListener===" + "onMemberQuit");
    }

    @Override
    public void onMemberUpdate(String s, List<TIMGroupMemberInfo> list) {
        Log.d(TAG,"===setGroupAssistantListener===" + "onMemberUpdate");
    }


    @Override
    public void onGroupAdd(TIMGroupCacheInfo timGroupCacheInfo) {
        Log.d(TAG,"===setGroupAssistantListener===" + "onGroupAdd");
        setChanged();
    ...
    public void onGroupDelete(String s) {
        Log.d(TAG,"===setGroupAssistantListener===" + "onGroupDelete");
        setChanged();
    ...
    public void onGroupUpdate(TIMGroupCacheInfo timGroupCacheInfo) {
        Log.d(TAG,"===setGroupAssistantListener===" + "onGroupUpdate");
        setChanged();
